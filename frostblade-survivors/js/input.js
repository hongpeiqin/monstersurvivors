export class InputManager {
  ...
  bindJoystick(root, knob) {
    ...
    const update = event => {
      ...
      // The keyboard reaches full speed immediately. The old analog curve started at a small
      // fraction of full speed, which felt like input latency even though events arrived on time.
      // Keep the visual travel analog, but make the game vector an immediate eight-direction unit.
